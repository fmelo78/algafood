...
import com.algawoks.algafood.api.model.output.ProdutoOutput;
...
public class RestauranteProdutoController {
	...
	@GetMapping
	public ResponseEntity<?> listar (@PathVariable Long restauranteId, @RequestParam (required = false) String status){
...
//	}
	...
	@PostMapping
	public ResponseEntity<?> adicionar (@PathVariable Long restauranteId, @RequestBody @Valid ProdutoInput produtoIn){
		Restaurante restaurante = restauranteService.buscarOuFalhar(restauranteId);
	...
	public ResponseEntity<?> alterar (@PathVariable Long restauranteId, @PathVariable Long produtoId, 
