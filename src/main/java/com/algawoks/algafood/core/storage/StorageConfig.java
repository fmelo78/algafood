...
import com.algawoks.algafood.core.storage.StorageProperties.TipoStorage;
import com.algawoks.algafood.domain.service.FotoStorageService;
import com.algawoks.algafood.infrastructure.storage.LocalFotoStorageService;
import com.algawoks.algafood.infrastructure.storage.S3FotoStorageService;
...
public class StorageConfig {
	...
	public AmazonS3 amazonS3() {
		var credentials = new BasicAWSCredentials(
				...
				storageProperties.getS3().getChaveSecreta());
